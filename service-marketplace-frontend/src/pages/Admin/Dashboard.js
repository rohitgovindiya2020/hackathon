...
const AdminDashboard = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            icon: (
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 10V8C21 6.89543 20.1046 6 19 6H5C3.89543 6 3 6.89543 3 8V16C3 17.1046 3.89543 18 5 18H10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M14 6V4C14 2.89543 14.8954 2 16 2H20C21.1046 2 22 2.89543 22 4V6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    ...
    return (
        <div className={styles['admin-dashboard']}>
            {/* Sidebar */}
            <aside className={`${styles['admin-sidebar']} ${sidebarOpen ? styles.open : styles.closed}`}>
                <div className={styles['sidebar-header']}>
                    <div className={styles['sidebar-logo']}>
                        <div className={styles['sidebar-logo-circle']}>
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {sidebarOpen && <span>Service Marketplace</span>}
                    </div>
                </div>
                ...
                <nav className={styles['sidebar-nav']}>
                    {menuItems.map((item, index) => (
                        <button
                            key={index}
                            className={`${styles['nav-item']} ${currentSection === item.id ? styles.active : ''}`}
                            onClick={() => navigate(`/admin/${item.id}`)}
                        >
                            <span className={styles['nav-icon']}>{item.icon}</span>
                            {sidebarOpen && <span className={styles['nav-text']}>{item.name}</span>}
                        </button>
                    ))}
                </nav>
                    ...
                    <div className={styles['admin-profile']}>
                        ...
                        {sidebarOpen && (
                            <div className={styles['profile-info']}>
                                <div className={styles['profile-name']}>{adminUser?.name || 'Admin'}</div>
                ...
                <header className={styles['admin-header']}>
                    <div className={styles['header-left']}>
                        ...
                        <div className={styles['header-title']}>
                            <h1>{menuItems.find(item => item.id === currentSection)?.name || 'Dashboard'}</h1>
                        ...
                        <>
                            ...
                            <div className={styles['stats-grid']}>
                                {stats.map((stat, index) => (
                                    <div key={index} className={styles['stat-card']}>
                                        ...
                                        <div className={styles['stat-content-body']}>
                            ...
                            <div className={styles.section}>
                                ...
                                <div className={styles['actions-grid']}>
                                    <button className={styles['action-card']} onClick={() => navigate('/admin/services')}>
                                        ...
                                        <div className={styles['action-content']}>
                                            ...
                                            <p>Manage categories and platform offerings</p>
                                        </div>
                                    </button>
                                    ...
                                    <button className={styles['action-card']}>
                                        ...
                                        <div className={styles['action-content']}>
                                            ...
                                            <p>Review pending service approvals</p>
                                        </div>
                                    </button>
                                    ...
                                    <button className={styles['action-card']}>
                                        ...
                                        <div className={styles['action-content']}>
                                            ...
                                            <p>Download analytics and data</p>
                                        </div>
                                    </button>

                                    <button className={styles['action-card']} onClick={() => navigate('/admin/settings')}>
                                        <div className={styles['action-icon']}>
                                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
