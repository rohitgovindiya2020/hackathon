...
import './ProviderChatModal.css';

const ProviderChatModal = ({ isOpen, onClose, initialPartner = null }) => {
    const { user } = useAuth();
    ...
    return (
        <div className="provider-chat-modal-overlay" onClick={onClose}>
            <div className="provider-chat-modal-container" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="provider-chat-sidebar">
                    ...
                    <div className="sidebar-conversations-list">
                        {loading && conversations.length === 0 ? (
                            ...
                            <div className="conv-status-message">
                                <span>{searchTerm ? 'No results found' : 'No conversations yet'}</span>
                            </div>
                        ) : (
                ...
                <div className="provider-chat-content">
                    {activePartner ? (
                        ...
                        <div className="chat-splash-screen">
                            ...
                            <h2>Marketplace Connect for Experts</h2>
                            <p>Select a customer on the left to start coordinating services.<br />Stay connected, grow your business.</p>
